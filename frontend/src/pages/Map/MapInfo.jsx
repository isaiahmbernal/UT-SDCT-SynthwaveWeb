    ...
    >
      ...
      <div className="z-[1] bg-black/80 flex flex-col gap-3 p-3 rounded-xl w-full h-full">
        <div className="w-full flex items-center justify-between">
          <h1 className="bg-black/80 text-white px-2 py-1 font-bold text-xl rounded-lg shadow-md">
            {selectedInfo.name}
          </h1>
          <motion.button
            className="bg-black/80 text-white font-bold px-4 py-2 rounded-lg shadow-md"
        ...
        <p className="text-justify h-full w-full bg-black/80 text-white overflow-y-scroll text-lg px-4 py-3 rounded-lg shadow-md">
          {selectedInfo.info}
        </p>
      </div>
    </motion.section>
