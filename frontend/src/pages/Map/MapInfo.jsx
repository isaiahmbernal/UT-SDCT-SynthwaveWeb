...
const MapInfo = ({ selectedInfo, setInfoShow }) => {
  return (
    <motion.section
      className="fixed bottom-[1%] w-[97%] z-10 h-[35vh] font-share-tech-mono shadow-2xl bg-black/90 border-[.1rem] border-border text-white flex flex-col items-center justify-between p-4 gap-4"
      initial={{ y: 100 }}
      animate={{ y: 0 }}
      exit={{ y: 300 }}
      key="map-info"
